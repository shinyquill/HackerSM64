void scroll_wf_dl_Sandfall_009_mesh_layer_5_vtx_0() {
	int i = 0;
	int count = 480;
	int height = 32 * 0x20;
	...
	int deltaY;
	Vtx *vertices = segmented_to_virtual(wf_dl_Sandfall_009_mesh_layer_5_vtx_0);
...
void scroll_wf_dl_Sandfall_001_mesh_layer_5_vtx_0() {
	int i = 0;
	int count = 1226;
	int height = 32 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(wf_dl_Sandfall_001_mesh_layer_5_vtx_0);
...
void scroll_wf() {
	scroll_wf_dl_Sandfall_009_mesh_layer_5_vtx_0();
	scroll_wf_dl_Level_007_mesh_layer_1_vtx_1();
	scroll_wf_dl_Sandfall_001_mesh_layer_5_vtx_0();
