...
const LevelScript level_castle_grounds_entry[] = {
	...
	AREA(1, castle_grounds_area_1),
		...
		OBJECT(MODEL_LUIGI, 567, 5, 4, 0, -40, 0, (DIALOG_000 << 16), bhvLuigiNPC),
		OBJECT(MODEL_STAR, 642, 5, 149, 0, -40, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_TOAD, 61, 5, 670, 0, 138, 0, (DIALOG_001 << 24), bhvToadMessage),
