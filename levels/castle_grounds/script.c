...
const LevelScript level_castle_grounds_entry[] = {
	...
	AREA(1, castle_grounds_area_1),
		...
		OBJECT(MODEL_RED_FLAME, 271, 5, 337, 0, 138, 0, (0x0B << 16), bhvFlame),
		OBJECT(MODEL_LUIGI, 567, 5, 4, 0, -40, 0, (0x00 << 16), bhvLuigiNPC),
		OBJECT(MODEL_TOAD, 61, 5, 670, 0, 138, 0, (0x01 << 16), bhvToadMessage),
		OBJECT(MODEL_NONE, 77, 163, -3495, 0, 180, 0, (0x01 << 16), bhvWarp),
		OBJECT(MODEL_NONE, 551, 82, 611, 0, -151, 0, 0x000A0000, bhvInstantActiveWarp),
		MARIO_POS(0x01, -151, 551, 82, 611),
		OBJECT(MODEL_NONE, -454, 89, -55, 0, 180, 0, (0x02 << 16), bhvWarp),
		OBJECT(MODEL_NONE, -246, 89, -259, 0, 138, 0, (0x0B << 16), bhvInstantActiveWarp),
	...
	AREA(2, castle_grounds_area_2),
		...
		OBJECT(MODEL_TOAD, -546, -289, -387, 0, -140, 0, (0x02 << 16), bhvToadMessage),
		OBJECT(MODEL_TOAD, 95, -289, 113, 0, 73, 0, (0x03 << 16), bhvToadMessage),
		OBJECT(MODEL_TOAD, 249, -289, -95, 0, 20, 0, (0x04 << 16), bhvToadMessage),
