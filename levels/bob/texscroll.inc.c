void scroll_bob_dl_Waterfall_004_mesh_layer_5_vtx_0() {
	int i = 0;
	int count = 261;
	int height = 64 * 0x20;
	...
	int deltaY;
	Vtx *vertices = segmented_to_virtual(bob_dl_Waterfall_004_mesh_layer_5_vtx_0);
...
void scroll_bob() {
	scroll_bob_dl_Waterfall_004_mesh_layer_5_vtx_0();
