...
const LevelScript level_ccm_entry[] = {
	...
	AREA(1, ccm_area_1),
		...
		WARP_NODE(0xFF, LEVEL_CASTLE_GROUNDS, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		...
		OBJECT(MODEL_NONE, -783, 607, -876, 0, 180, 0, 0x01000000, bhvHiddenDragonCoin),
		...
		OBJECT(MODEL_NONE, -229, 492, -45, 0, 180, 0, 0x00000000, bhvFlame),
