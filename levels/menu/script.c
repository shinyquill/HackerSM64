...
const LevelScript level_main_menu_entry_file_select[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_HUB,         hub_geo),
    ...
    AREA(/*index*/ 1, geo_menu_file_select_strings_and_menu_cursor),
        ...
        OBJECT(/*model*/ MODEL_HUB, /*pos*/ 1100, 1200, -4000, /*angle*/ 0, 60, 0, /*behParam*/ BP(0x04, 0x00, 0x00, 0x00), /*beh*/ bhvYellowBackgroundInMenu),
        TERRAIN(/*terrainData*/ main_menu_seg7_collision),
    END_AREA(),

    FREE_LEVEL_POOL(),
    LOAD_AREA(/*area*/ 1),
    SET_MENU_MUSIC(/*seq*/ SEQ_FILESELECT),
