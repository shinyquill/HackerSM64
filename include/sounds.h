...
#define SOUND_GENERAL_WALL_EXPLOSION             /* 0x300F0081 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x0F, 0x80, SOUND_DISCRETE)
...
#define SOUND_GENERAL_CUSTOM_TOAD_SCREAM	                      SOUND_ARG_LOAD(SOUND_BANK_GENERAL, 0x80, 0x80, SOUND_CONSTANT_FREQUENCY | SOUND_DISCRETE)
#define SOUND_GENERAL_CUSTOM_TOAD_SCREAM_2	                      SOUND_ARG_LOAD(SOUND_BANK_GENERAL, 0x81, 0x80, SOUND_CONSTANT_FREQUENCY | SOUND_DISCRETE)
#define SOUND_GENERAL_CUSTOM_DRAGON_COIN	                      SOUND_ARG_LOAD(SOUND_BANK_GENERAL, 0x82, 0x85, SOUND_CONSTANT_FREQUENCY | SOUND_DISCRETE)
#define SOUND_GENERAL_CUSTOM_RED_CIRCLE	                          SOUND_ARG_LOAD(SOUND_BANK_GENERAL, 0x83, 0x85, SOUND_CONSTANT_FREQUENCY | SOUND_DISCRETE)
#define SOUND_GENERAL_CUSTOM_SPRING	                              SOUND_ARG_LOAD(SOUND_BANK_GENERAL, 0x84, 0x80, SOUND_CONSTANT_FREQUENCY | SOUND_DISCRETE)
#define SOUND_GENERAL_CUSTOM_SLIP	                              SOUND_ARG_LOAD(SOUND_BANK_GENERAL, 0x85, 0x80, SOUND_CONSTANT_FREQUENCY | SOUND_DISCRETE)
#endif // SOUNDS_H
